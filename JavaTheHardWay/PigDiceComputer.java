  ...
  public static void main(String[]args) {
    ...
    do {
      ...
      do {
        ...
        if (roll == 1) {
          System.out.println("\tThat ends your turn, and you lost all of your points for this turn.");
          turnTotal = 0;
        }
        else {
          turnTotal += roll;
          System.out.print("\tYou have " + turnTotal + " points");
          System.out.print(" so far in this round\n");
      ...
      if (ptot < 100) {
        ...
        } while (roll != 1 && turnTotal < 23);

        ctot += turnTotal;
        System.out.print("\tComputer ends the turn with ");
